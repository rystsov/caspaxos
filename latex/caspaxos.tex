...
Indeed without the mandatory re-scan, it's possible to sequentially replace every acceptor with an empty acceptor, lose all data and violate linearizability.
...
{\bf Acknowledgements}. We thank Tobias Schottdorf and Greg Rogers who wrote TLA+ specs for CASPaxos, and Ezra Hoch who found a flaw in the first version of the deletion process \ref{deletion}.
