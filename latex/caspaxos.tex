...
\title{CASPaxos: Replicated State Machines without logs. Extended Version}
...
Its symmetric peer-to-peer approach achieves optimal commit latency in wide-area networks and doesn’t cause temporary unavailability when any $\lfloor \frac{N-1}2 \rfloor$ of $N$ nodes crash. 

The paper describes CASPaxos, proves its safety properties, covers cluster membership change and evaluates the characteristics of a CASPaxos-based prototype of key-value storage.
\end{abstract}
