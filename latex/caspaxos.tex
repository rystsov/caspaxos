...
The EPaxos paper explains how leader based consensus protocols lead to a cluster wide unavailability when a leader crashes or is isolated from the cluster:
...
CASPaxos doesn't suffer from this behaviour because all of its nodes are homogeneous and an isolation of one of them doesn't affect processes running against the others. An experimental study\footnote{\href{https://github.com/rystsov/perseus}{https://github.com/rystsov/perseus}} of distributed consistent databases with default settings during a leader isolation supports this a priori reasoning:
