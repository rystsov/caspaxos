...
Indeed without the mandatory re-scan, it's possible sequentially replace every acceptor with an empty acceptor, lose all data and violate linearizability.
