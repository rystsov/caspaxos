...
It's convenient to use tuples as ballot numbers, to generate it a proposer combines a local increasing counter with its proposer's numerical ID: (counter, ID). To compare ballot tuples, we should compare the first component of the tuples and use ID only as a tiebreaker.
